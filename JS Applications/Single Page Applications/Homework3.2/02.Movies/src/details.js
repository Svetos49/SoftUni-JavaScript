    ...
    try {
        ...
        if (userId) {
            if (userId == data._ownerId) {
                ...
                deleteAnchor.addEventListener('click', deleteMovie);
                editAnchor.addEventListener('click', handleForm); 
                ...
                if (hasUserLiked.length > 0) {
                    ...
                    likeAnchor.addEventListener('click', () => removeLike(event, hasUserLiked[0]._id)); 
        ...
        detailsSection.appendChild(fragment); 
