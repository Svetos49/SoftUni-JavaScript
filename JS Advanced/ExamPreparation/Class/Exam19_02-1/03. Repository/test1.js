...
describe('Repository', () => {
   ...
   describe('Initialization', () => {
       it('Shoud add props property on init', () => {
       ...
       it('Shoud have property data on init', () => {
       ...
       it('Should have nextId function on init', () => {
        ...
        expect(typeof repository.nextId).to.deep.equal('function');
       });
   ...
   describe('Add entity', () => {
       ...
       it('Should throw error if property has other type', () => {
        let entity = {
          ...
          expect(() => repository.add(entity)).throw(Error, `Property birthday is not of correct type!`);
       });
   ...
   describe('Get count', () => {
       ...
       it('Should return zero if no added entites', () => {
           let repository =  new Repository(properties);
   ...
   describe('Get Id', () => {
       ...
       it('Should throw error when no id is found', () => {
        ...
        expect(() => repository.getId(1)).throw(Error, `Entity with id: 1 does not exist!` )
       })
   })

   describe('Update', () => {
       it('Should update one valid id with another', () => {
           let newEntity = {
            name: "Gosho",
            age: 32,
 ...
 it('Should throw error when deleting already deleted entity', () => {
  ...
  it('Should have count from 0 if add and remove multiple entities', () => {
    let repo = new Repository(properties);
