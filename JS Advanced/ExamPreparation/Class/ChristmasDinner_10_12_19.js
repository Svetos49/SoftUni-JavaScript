class ChristmasDinner {
    ...
    /** 
     * @param {{recipeName: string, productList: Array<string}} recipe
     */
    ...
    showAttendance() {
       ...
       Object.entries(this.guests).forEach(([guestName, dish]) => {
           result.push(`${guestName} will eat ${dish}, which consists of ${this.dishes.find(d => d.recipeName  == dish).productList.join(', ')}`)
       });
       return result.join('\n')
    }
